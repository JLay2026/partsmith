...
- Render 3D + 2D views as inline PNGs
...
only) — adapt for your deployment.
...
| `/render/3d` | POST | 3D view, base64 PNG. Views: `front`, `back`, `left`, `right`, `top`, `bottom`, `iso`, `iso_back` |
| `/render/2d` | POST | 2D orthographic view with optional dimension annotations, base64 PNG |
| `/render/multiview` | POST | Composite: front + right + top + iso |
